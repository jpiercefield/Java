...
public class Sorting
{
    ...
    */
   public static <E extends Comparable<E>> void selectionSort(E[] sort)
   {
      if (sort != null)
      {
    ...
    */
   public static <E extends Comparable<E>> void selectionSort (E[] sort, int n)
   {
    ...
    * The entire array is sorted.<br>  
    */
   public static <E extends Comparable<E>> void insertionSort(E[] sort)
   {
      if (sort != null)
      {
    ...
    * The number of items sorted (starting at the beginning of the array) is n.
    */
   public static <E extends Comparable<E>> void insertionSort (E[] sort, int n)
   {
      E temp;
      int position;
